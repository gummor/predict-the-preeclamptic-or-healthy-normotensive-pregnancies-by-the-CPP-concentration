...
> **Ethical Statement:**
> All clinical data used for model training consist of simulated cohort data (n=1000) according to reported literature distributions. No Protected Health Information (PHI) is involved. This project is intended for methodology demonstration and is not a clinical diagnostic tool.
